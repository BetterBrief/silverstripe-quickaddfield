...
class QuickAddField extends OptionsetField
{
    ...
    public function setLabelField($var)
    {
        $this->labelField = $var;
    }

    public function setSelectAll(bool $val)
    {
        $this->selectAll = $val;
    }
    ...
    public function mergeDefaults($defaults = array())
    {
    ...
    public function setAddTitle($val)
    {
        $this->addTitle = $val;
    }
    ...
    public function findOrAdd($request)
    {
